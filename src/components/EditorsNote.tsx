  ...
  return (
    <section className="relative py-32 px-6 md:px-12 bg-paper">
      <div className="max-w-3xl mx-auto">
        ...
        >
          Some people enter your life like a sentence you didn’t know you were waiting to read. The kind that makes you put the book down for a moment and stare at the ceiling, smiling. This issue is a small attempt to bind one such sentence into something you can hold. Inside, you’ll find a magazine made for an audience of exactly one — interviews with no journalists, fashion shoots with no photographers, and a love letter with no return address other than this page. Happy birthday, my favorite headline.
        </motion.p>
